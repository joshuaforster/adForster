    ...
    <footer className="p-4 bg-gray-100 sm:p-6 dark:bg-gray-800">
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="sm:flex sm:items-center sm:justify-between text-center">
          <span className="text-sm text-gray-500 sm:text-center dark:text-white">© {currentYear} <Link to="/" className="hover:underline">Integrity Fitness Education™</Link>. All Rights Reserved.</span>
        </div>
      </div>
