        ...
        <div className="px-6 lg:px-8">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <form action="#" method="POST" className="mt-16">
              ...
              <div className="mt-10 flex justify-end lg:justify-start border-t border-gray-900/10 dark:border-gray-700 pt-8">
                <button
                  type="submit"
                  className="rounded-md bg-customRed px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-customRed dark:focus:ring-customRed focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-customRed"
                >
                  Send message
                </button>
              </div>
